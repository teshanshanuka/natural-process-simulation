...
# or an abstract node of the quad-tree if it has child.
    ...
    def __repr__(self) -> str:
        return f"m={self.m} pos={self.m_pos} momentum={self.momentum}"
...
#  For simplicity, keep the angular momentum in the x-y-plane, but assume a null initial z-momentum for all the bodies.
for body in bodies: 
